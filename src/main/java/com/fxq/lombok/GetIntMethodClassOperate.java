...
import com.fxq.annotation.GetIntMethod;
...
public class GetIntMethodClassOperate {
            ...
            if (Tools.protosMap.size() > 0) {
                for (String protoPath : Tools.protosMap.keySet()) {
                    ...
                    for (String innerClassName : list) {
                        ...
                        if (innerCtClass.hasAnnotation(GetIntMethod.class)) {
                            GetIntMethod annotation = (GetIntMethod) innerCtClass.getAnnotation(GetIntMethod.class);
                            String[] value = annotation.value();
                            // 创建新的方法
                            CtMethod newMethod = new CtMethod(pool.get("java.lang.Integer"), "getInt", new CtClass[]{pool.get("java.lang.String")}, innerCtClass);
