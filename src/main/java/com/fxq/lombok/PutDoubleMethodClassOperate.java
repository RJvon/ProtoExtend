...
public class PutDoubleMethodClassOperate {
            ...
            if (Tools.protosMap.size() > 0) {
                for (String protoPath : Tools.protosMap.keySet()) {
                    ...
                    for (String innerClassName : list) {
                        ...
                        builder.defrost();
                        if (builder.hasAnnotation(PutDoubleMethod.class)) {
                            PutDoubleMethod annotation = (PutDoubleMethod) builder.getAnnotation(PutDoubleMethod.class);
                            String[] value = annotation.value();
                            // 创建新的方法
                            CtMethod newMethod = new CtMethod(builder, "put", new CtClass[]{pool.get("java.lang.String"), CtClass.doubleType}, builder);
